...
class TestWatchCells:
    ...
    def test_reports_a_cell_of_another_pool_as_gone(self):
        """It is not this view's cell, so the only thing to say about it is that there is nothing to drive."""
        ...
        assert reported == [("trainer-0", None)]
