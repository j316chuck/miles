...
class TestGpuOffsetPairing:
    ...
    def test_refuses_an_offset_that_splits_an_inference_cell_across_trainer_cells(self):
        ...
        with pytest.raises(pydantic.ValidationError, match="straddle two trainer cells"):
            _layout(
                num_inference_cells=1,
                num_trainer_cells=2,
...
class TestAssertColocateSupported:
    ...
    def test_refuses_an_inference_cell_wider_than_a_trainer_cell(self):
