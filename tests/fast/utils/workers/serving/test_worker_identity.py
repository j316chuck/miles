...
class TestReadWorkerIdentity:
    def test_numbers_the_workers_of_a_multi_pod_cell_end_to_end(self):
        ...
        assert identity.worker_in_cell_index == 19
    ...
    def test_gives_each_worker_of_a_pod_its_own_gpus(self):
        ...
        first = read_worker_identity(scheduling=pod, environ=_environ(SUBPROCESS_INDEX_ENV_VAR="0"))
        second = read_worker_identity(scheduling=pod, environ=_environ(SUBPROCESS_INDEX_ENV_VAR="1"))
